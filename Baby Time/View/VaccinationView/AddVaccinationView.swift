...
/// Bottom sheet for adding a vaccination entry (date, time, note). Like FeedingView.
final class AddVaccinationView: UIView {
    ...
    private lazy var noteTextField: UITextField = {
        ...
        view.placeholder = "e.g. Routine vaccine, flu shot"
